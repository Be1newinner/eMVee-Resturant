      ...
      >
        ...
        <View style={{ marginVertical: 20, gap: 20 }}>
          ...
          <Input
            ...
            caption={error?.email && <Text status="danger" style={{ fontSize: 13, fontWeight: '700', marginTop: 5 }}>{error?.email}</Text>}
          ...
          <Input
            ...
            size="large"
            style={{ elevation: 5 }}
            caption={error?.password && <Text status="danger" style={{ fontSize: 13, fontWeight: '700', marginTop: 5 }}>{error?.password}</Text>}
          />
          {isLoading ? (
          ...
          <Text style={{ textAlign: "center" }}>
            ...
            <Text status="primary" onPress={() => router.replace("register")}>
              Sign Up
            </Text>
          </Text>
        </View>
